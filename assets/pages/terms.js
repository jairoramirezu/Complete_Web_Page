...
<header>
    <div class="mainInfo">
        <h1 class="mainInfo--title">T&eacute;rminos del servicio.</h1>
        <h2 class="planCardChar--des">
            </br>
            <strong class="strong-terms">GENERALIDADES</strong>
            </br>
            Themis gestiona este sitio web. En todo el sitio, los términos "nosotros", "nos" y "nuestro" se refieren en lo sucesivo a Themis. Themis ofrece esta página web, incluida toda la información, las herramientas y los servicios que se ponen en este sitio a disposición suya, el usuario, siempre y cuando acepte la totalidad de los términos, condiciones, políticas y avisos contemplados aquí.
            </br></br>
            ...
            <strong class="strong-terms">SECCIÓN 1: TÉRMINOS DE LA TIENDA ONLINE</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 2: CONDICIONES GENERALES</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 3: EXACTITUD, TOTALIDAD Y CRONOLOGÍA DE LA INFORMACIÓN</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 4: MODIFICACIONES AL SERVICIO Y PRECIOS</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 5: PRODUCTOS O SERVICIOS (si corresponde)</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 6: EXACTITUD DE LA FACTURACIÓN Y DE LA INFORMACIÓN DE LA CUENTA</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 7: HERRAMIENTAS OPCIONALES</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 8: ENLACES DE TERCEROS</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 9: COMENTARIOS DE LOS USUARIOS, OPINIONES Y OTRAS COMUNICACIONES</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 10: INFORMACIÓN PERSONAL</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 11: ERRORES, INEXACTITUDES Y OMISIONES</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 12: USOS PROHIBIDOS</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 13: DESCARGO DE RESPONSABILIDAD DE GARANTÍAS; LIMITACIÓN DE RESPONSABILIDAD</strong>
            </br>
            No somos abogados, no podemos brindar asesoría ni consejo legal, tampoco podemos representarte legalmente. Si necesita consejo o representación legal ubique un abogado con licencia en The Florida Bar.
            </br></br>
            ...
            <strong class="strong-terms">SECCIÓN 16: RESCISIÓN</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 17: ACUERDO COMPLETO</strong>
            </br>
            ...
            <strong class="strong-terms">SECCIÓN 18: LEY APLICABLE</strong>
            </br>
            Los presentes Términos del servicio y cualquier acuerdo por separado por el cual le proporcionemos Servicios se regirán e interpretarán de acuerdo con las leyes de Doral, FL, 33166, Estados Unidos.
            </br></br></br>
            <strong class="strong-terms">SECCIÓN 19: CAMBIOS EN LOS TÉRMINOS DEL SERVICIO</strong>
            </br>
            ...
            <strong class="strong-terms">SECTION 20: INFORMACIÓN DE CONTACTO</strong>
            </br>
            Las preguntas sobre los Términos del servicio se deben enviar a themis@themis.la
        </h2>
    </div>
</header>
${footer}
